    ...
    <>
      <section className="py-16 lg:py-24 bg-surface-dark border-t border-gray-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-bold uppercase tracking-wide text-white leading-tight mb-4">
            Ready to Claim Your <span className="text-primary">Third Path?</span>
          </h2>
          <p className="text-lg text-gray-400 max-w-2xl mx-auto leading-relaxed mb-8">
            Apply for personalized coaching or explore our resources to get started.
          </p>
          ...
          <div className="flex flex-col space-y-4 w-full">
            <div className="flex justify-center space-x-6 pb-4">
              <a
                ...
                href="https://instagram.com/coachdwayned"
                target="_blank"
